...
import { MantIncidencias } from './components/mantenimientos/MantIncidencias';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin/mantenimientos/incidencias" element={isAdmin ? <MantIncidencias user={user} /> : <Navigate to="/" />} />
